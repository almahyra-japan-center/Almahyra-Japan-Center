...
bg = get_base64('latarbelakang_20260903_093332_0000.png') # UDAH AKU GANTI SESUAI NAMAMU
logo = get_base64('logo.png')

bg_css = f"url(data:image/png;base64,{bg})" if bg else "linear-gradient(180deg, #FFF0F5 0%, #ffffff 100%)" # PNG YA BUKAN JPG
...
.stButton>button:hover, .stLinkButton>button:hover {{ transform: scale(1.03); background: linear-gradient(90deg, #B71C1C 0%, #D32F2F 100%); }}
