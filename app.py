...
.section {{ background: rgba(255,255,255,0.94); padding: 25px; border-radius: 20px; margin-bottom: 25px; box-shadow: 0 8px 25px rgba(211, 47, 47, 0.15); border: 1px solid rgba(211, 47, 47, 0.2); backdrop-filter: blur(4px); transition: transform 0.3s ease; }}
